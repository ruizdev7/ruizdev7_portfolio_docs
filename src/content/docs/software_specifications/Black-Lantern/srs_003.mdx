...
<Tabs>
  <TabItem value="UC-004" label="UC-004" title="UC-004">  
  ...
  **Description**: The dropdown menu in the navigation bar allows users to preview available courses within a category. It displays up to three courses per category along with a link to explore the full list.  
  ...
  <TabItem value="UC-005" label="UC-005" title="UC-005">  
  ...
  **Description**: Allows users to type keywords in the dropdown menu to filter course categories dynamically.
  ...
  <TabItem value="UC-006" label="UC-006" title="UC-006">  
  ...
  **Description**: Ensures the dropdown menu functions correctly on mobile devices (e.g., touch gestures instead of hover).
  ...
  <TabItem value="UC-007" label="UC-007" title="UC-007">  

  **Priority**: High  
  **Description**: Provides a mechanism to filter course categories dynamically within the dropdown menu, ensuring users can quickly locate relevant options based on their input.
  ...
  <TabItem value="UC-008" label="UC-008" title="UC-008">  
  ...
  **Description**: Ensures different user roles (e.g., students, instructors, guests) see only relevant course categories.
  ...
  <TabItem value="UC-009" label="UC-009" title="UC-009">  
  ...
  **Description**: Displays a section in the dropdown with the user’s recently viewed courses for quick access.
  ...
  <TabItem value="UC-010" label="UC-010" title="UC-010">  
  ...
  **Description**: Uses user preferences or browsing history to recommend relevant courses directly in the dropdown.
  ...
  | **Use Case Associations**     | UC-010: Recently Viewed Courses in Dropdown |
  | **Traceability To**           | SRS-003 |
...
|--------------------------------|----------------------------------|
| **Dropdown Expansion**         | The dropdown menu must expand when the user hovers over or clicks a category in the navigation bar. |
| **Dropdown Collapse**          | The menu should close when the user moves the cursor away (desktop) or taps outside of it (mobile). |
| **Course Display Limit**       | Each category must display a maximum of three courses. |
| **Explore More Link**          | A link must be present in each category to allow users to explore the full list of courses. |
| **Mobile Compatibility**       | The dropdown must be fully functional on mobile devices with touch interactions. |
| **Search Functionality**       | Users should be able to filter courses using a search input field within the dropdown. |
| **Performance Optimization**   | The dropdown should load dynamically and respond instantly to user interactions. |
| **Responsiveness**             | The menu must work correctly across different screen sizes and orientations. |
...
|--------------------------|-------------|
| **Performance**         | The dropdown menu must load and respond to user interactions within 200ms. |
| **Scalability**         | The system should support an increasing number of courses and categories without performance degradation. |
| **Security**           | Only authorized users should be able to access certain course categories if role-based access control is implemented. |
| **Cross-Browser Compatibility** | The dropdown should function correctly on all major browsers (Chrome, Firefox, Safari, Edge). |
| **Mobile Responsiveness** | The dropdown menu must work smoothly on devices with different screen sizes, including smartphones and tablets. |
| **Error Handling**     | If an error occurs while fetching course data, a fallback message must be displayed instead of breaking the UI. |
| **Maintainability**    | The dropdown implementation should be modular, allowing easy updates and improvements without affecting other components. |
